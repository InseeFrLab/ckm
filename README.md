...
[![minimum R version](https://img.shields.io/badge/R%3E%3D-4.1-blue.svg)](https://github.com/InseeFrLab/ckm/blob/main/DESCRIPTION)
...
About the step by step process used to calibrate the method, you can refer to Jamme (2025) [10.5281/zenodo.21930561](https://doi.org/10.5281/zenodo.21930561). 

For more information on the modification of the transition matrix suggested with the `stack` argument, you can refer to 
Jamme (2026) [10.13140/RG.2.2.19275.55840](https://doi.org/10.13140/RG.2.2.19275.55840).  

The method and the package are designed to perturb only frequency tables.
